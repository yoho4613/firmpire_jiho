...
import { useGetActorDetailQuery, useGetMovieCreditsQuery } from '../../services/TMDB';
...
const Actors = () => {
  ...
  <>
    <Grid container>
      <Grid item lg={5} xl={4}>
        <img className={classes.image} src={`https://image.tmdb.org/t/p/w500/${data.profile_path}`} />
